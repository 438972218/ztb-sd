...
docker tag 10.20.54.143:8000/ztb-sd/eureka:latest eureka:latest

echo ------------ save tar.gz ------------
docker save eureka:latest > ../../../image/image_service/eureka.tar.gz
...
sshpass -p $tunnel_to_password \
scp -r ../../../image/image_service/eureka.tar.gz $tunnel_to_username@$tunnel_to_ip:$tunnel_to_path
