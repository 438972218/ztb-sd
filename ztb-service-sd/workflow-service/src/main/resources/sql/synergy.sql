...
-- ----------------------------
INSERT IGNORE INTO `xdc_t_mail_template` (`id`, `name`, `type`, `template`, `default_value`, `created_time`, `updated_time`, `created_user`, `updated_user`, `description`) VALUES (1, '签名模板', 2, '<div class="template-signature"><p style="margin: 30px 0 0px 20px;">需要任何帮助或说明，请拨打我们的热线支持电话：</p><p style="margin: 5px 20px;">${telephone}</p></div>', '{\"telephone\":\"0510-85318532\"}', 1629863427000, NULL, NULL, NULL, NULL);
