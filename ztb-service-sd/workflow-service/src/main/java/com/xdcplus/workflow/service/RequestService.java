...
public interface RequestService extends BaseService<Request, RequestVO, Request> {
     ...
     * @return {@link RequestVO}
     */
    RequestVO findOne(Long requestId, Boolean isReturnRelation);
    ...
    /**
     * 查询请求列表根据请求id列表或创建用户列表
     *
     * @param requestFilterDTO 请求过滤dto
     * @return {@link List<Long>}
     */
    List<Long> findRequestIdsByRequestIdsOrCreatedUsers(RequestFilterDTO requestFilterDTO);
