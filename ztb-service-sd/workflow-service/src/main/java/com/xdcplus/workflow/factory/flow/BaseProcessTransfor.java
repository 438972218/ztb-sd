...
public class BaseProcessTransfor implements ProcessTransfor {
     ...
     */
    List<ProcessConfigVO> findConfigByProcessIdAndFromStatusId(Long processId, Long requestId,
        ...
        if (CollectionUtil.isNotEmpty(processConfigVOList)) {
            processConfigVOList.forEach(a -> {
                ...
                Optional.ofNullable(userDestinationFactory.postProcess(userDestinationParam)).ifPresent(a::setToUserId);
            });
        }
