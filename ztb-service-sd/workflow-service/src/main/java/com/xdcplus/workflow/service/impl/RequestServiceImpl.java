...
public class RequestServiceImpl extends BaseServiceImpl<Request, RequestVO, Request, RequestMapper> implements RequestService {
    ...
    @Override
    public RequestVO findOne(Long requestId, Boolean isReturnRelation) {
        Assert.notNull(requestId, ResponseEnum.THE_ID_CANNOT_BE_EMPTY.getMessage());
        return this.objectConversion(this.getById(requestId), isReturnRelation);
    }
    ...
    public List<Long> findRequestIdsByRequestIdsOrCreatedUsers(RequestFilterDTO requestFilterDTO) {
        ...
        List<Long> requestList = requestMapper.findRequestIdsByRequestIdsOrCreatedUsers(requestQuery);
