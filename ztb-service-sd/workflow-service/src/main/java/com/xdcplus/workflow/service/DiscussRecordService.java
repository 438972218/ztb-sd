 ...
 * @since 2021-08-18
 */
public interface DiscussRecordService extends BaseService<DiscussRecordBO, DiscussRecordVO, DiscussRecord> {
     ...
     */
    List<DiscussRecordBO> findDiscussRecordByGroupId(Long groupId);
     ...
     * @return {@link List<DiscussRecordBO>}
     */
    List<DiscussRecordBO> findDiscussRecordByGroupIds(Set<Long> groupIds);
