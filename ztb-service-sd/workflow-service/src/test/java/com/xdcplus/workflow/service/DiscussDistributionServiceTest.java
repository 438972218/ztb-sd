...
class DiscussDistributionServiceTest extends WorkflowServiceApplicationTests {
    ...
    void findDiscussRecordsByGroupId() {
        ...
        List<DiscussRecordVO> discussRecordVOList = discussDistributionService.findDiscussRecordsByGroupId(1448168269104615425L);
    ...
    void findDiscussRecordsByRequestId() {
        ...
        List<DiscussRecordVO> discussRecordVOList = discussDistributionService.findDiscussRecordsByRequestId(1448133149563883522L);
