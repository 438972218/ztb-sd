...
import com.xdcplus.workflow.common.pojo.dto.RequestFlowTransferNodeFilterDTO;
...
class RequestFlowServiceTest extends WorkflowServiceApplicationTests {
    ...
    @Test
    void findRequestFlowTransferNode() {

        RequestFlowTransferNodeFilterDTO requestFlowTransferNodeFilterDTO = new RequestFlowTransferNodeFilterDTO();
        requestFlowTransferNodeFilterDTO.setRequestId(1433267735088676866L);
        requestFlowTransferNodeFilterDTO.setToStatusId(1430091754389970945L);

        List<RequestFlowVO> requestFlowVOList = requestFlowService.findRequestFlowTransferNode(requestFlowTransferNodeFilterDTO);
