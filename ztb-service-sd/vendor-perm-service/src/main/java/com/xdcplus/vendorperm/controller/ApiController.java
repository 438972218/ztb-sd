...
public class ApiController extends AbstractController {
    ...
    @ApiOperation("注册用户(不发邮件)")
    @PostMapping(value = "registerUserNotSendEmail", produces = MediaType.APPLICATION_JSON_VALUE)
    ResponseVO<SysUserVo> registerUserNotSendEmail(@Validated @RequestBody RegisterUserDto registerUserDto){
        log.info("insert:{}", registerUserDto.toString());

        return ResponseVO.success(sysUserService.registerUserNotSendEmail(registerUserDto));
    }

    @ApiOperation("注册用户(覆盖原始数据)")
    @PostMapping(value = "registerUserCover", produces = MediaType.APPLICATION_JSON_VALUE)
    ResponseVO<SysUserVo> registerUserCover(@Validated @RequestBody RegisterUserDto registerUserDto){
        log.info("insert:{}", registerUserDto.toString());
        return ResponseVO.success(sysUserService.registerUserCover(registerUserDto));
    }
    ...
    ResponseVO<SysUserVo> registerUserNotSendEmailAndCover(@Validated @RequestBody RegisterUserDto registerUserDto){
        log.info("insert:{}", registerUserDto.toString());

        return ResponseVO.success(sysUserService.registerUserNotSendEmailAndCover(registerUserDto));
    }
    ...
    ResponseVO insertUserRole(@RequestBody SysUserRole sysUserRole){
        log.info("insert:{}", sysUserRole.toString());
        sysUserRole.setCreatedUser("admin");
        sysUserRole.setCreatedTime(DateUtil.current());

        return ResponseVO.success(sysUserRoleService.insert(sysUserRole));
    }
    ...
    public ResponseVO<Map<String,String>> queryVendorUserMap() {
        return ResponseVO.success(this.sysUserService.queryMap());
    }
     ...
     *
     */
    @ApiOperation("查询出所有的用户")
    @GetMapping(value = "queryAllVendorUser", produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseVO<List<SysUserVo>> queryAllVendorUser() {
        return ResponseVO.success(this.sysUserService.getAllSysUserVo());
    }
    ...
    public ResponseVO<PageVO<SysUserVo>> querySysUserVOPageVO(@RequestBody SysUserFilterDto sysUserFilterDto) {
        return ResponseVO.success(this.sysUserService.getSysUserServicePageByCondition(sysUserFilterDto));
    }
}
