...
public class SysUserController extends AbstractController {
    ...
    @ApiOperation("更新邮箱")
    @PutMapping(value = "updateMailById", produces = MediaType.APPLICATION_JSON_VALUE)
    ResponseVO updateMailById( @Validated @RequestBody SysUserDto sysUserDto){
        log.info("updateMailById:{}", sysUserDto.toString());
        sysUserService.updateMailById(sysUserDto,AuthUtils.getCurrentUser());
        return ResponseVO.success();
    }
