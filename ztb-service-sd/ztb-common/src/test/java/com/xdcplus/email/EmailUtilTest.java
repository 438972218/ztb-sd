...
public class EmailUtilTest {
    ...
    static {
        ...
        from.setEmail("epurchase@suntech-power.com");
        from.setName("epurchase");
        ...
        emailProperties.setHost("172.18.0.21");
        emailProperties.setPort(25);

        emailProperties.setSslEnable(Boolean.FALSE);
        emailProperties.setDebug(Boolean.TRUE);
        emailProperties.setAvoidAuthEnable(Boolean.FALSE);
        emailProperties.setUsername("S0735");
        emailProperties.setPassword("Suntech@2021");
        emailProperties.setFrom(from);
        emailProperties.setDebug(true);
        emailProperties.setStartTlsEnabled(false);
