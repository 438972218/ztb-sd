...
public enum ResponseEnum {
    ...
    DATA_DICTIONARY_SELECT_FAILD(3905,"数据字典查询失败"),
    ...
    THE_TEMPORARY_GROUP_ALREADY_EXISTS(5710, "讨论组已存在"),
    ...
    API_USER_ROLE_INSERT_FAIL(9006, "API用户角色新增失败"),
    // 5400：询价单
    ...
    BID_VENDOR_EXIST(5503, "招标单供应商已存在"),
    BID_TITLE_IS_EXIST(5503,"招标单标题已存在"),
    BID_VENDOR_DETAIL_SELECT_FAIL(5503, "招标单供应商文件明细查询失败"),
    BID_VENDOR_USER_SELECT_FAIL(5503, "用户未绑定供应商"),
    BID_SPECIALIST_SELECT_FAIL(5504, "评委查询失败"),
    BID_SPECIALIST_EXIST(5504, "招标单评委已存在"),
    ...
    BID_DETAIL_SELECT_ERROR(5507, "商业标|技术标|资质标查询失败"),
    BID_VENDOR_REPLY_ERROR(5508, "招标已结束，无法提交回复"),
