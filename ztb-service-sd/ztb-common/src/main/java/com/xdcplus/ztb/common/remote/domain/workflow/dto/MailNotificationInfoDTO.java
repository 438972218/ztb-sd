...
@Data
@ApiModel("邮件通知参数对照对象")
public class MailNotificationInfoDTO implements Serializable {
    ...
    private List<@Valid MailBeanInfo> to;

    /**
     * 抄送人
     */
    @ApiModelProperty(value = "抄送人")
    private List<MailBeanInfo> cc;

    /**
     * 密送人
     */
    @ApiModelProperty(value = "密送人")
    private List<MailBeanInfo> bcc;

    /**
     * 回复人
     */
    @ApiModelProperty(value = "回复人")
    private List<MailBeanInfo> reply;
