package com.xdcplus.ztb.common.exceptions.handler;
...
public class ZtbWebExceptionHandler {
     ...
     * @date 2019/4/3 8:46
     */
    @ExceptionHandler(value = ZtbWebException.class)
    public ResponseVO ztbWebExceptionHandler(ZtbWebException e) {

        log.error("ztbWebExceptionHandler  {}", e.getMessage());
    ...
    public ResponseVO defaultErrorHandler(Exception e) {
        ...
        if (e.getCause() instanceof ZtbWebException) {
            ztbWebExceptionHandler((ZtbWebException) e);
        }
