...
import com.xdcplus.statement.common.pojo.dto.PaidVendorDTO;
import com.xdcplus.statement.common.pojo.dto.PaidVendorFilterDTO;
...
import com.xdcplus.statement.generator.PaidVendorBaseService;
...
public class PaidVendorBaseServiceImpl<S, T, E, M extends BaseMapper<E>> extends BaseServiceImpl<PaidVendor, PaidVendorVO, PaidVendor, PaidVendorMapper> implements PaidVendorBaseService<S, T, E> {
    ...
    protected List<PaidVendor> queryPaidVendorList(PaidVendorFilterDTO paidVendorFilterDTO) {
