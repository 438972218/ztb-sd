...
import com.xdcplus.statement.common.pojo.dto.ProjectMemberDTO;
import com.xdcplus.statement.common.pojo.dto.ProjectMemberFilterDTO;
...
import com.xdcplus.statement.generator.ProjectMemberBaseService;
...
public class ProjectMemberBaseServiceImpl<S, T, E, M extends BaseMapper<E>> extends BaseServiceImpl<ProjectMember, ProjectMemberVO, ProjectMember, ProjectMemberMapper> implements ProjectMemberBaseService<S, T, E> {
    ...
    public PageVO<ProjectMemberVO> queryProjectMember(ProjectMemberFilterDTO projectMemberFilterDTO) {
        ...
        List<ProjectMemberVO> projectMemberVOS = this.objectConversion(projectMemberList);
        if(CollectionUtil.isNotEmpty(projectMemberVOS)){
            for (ProjectMemberVO projectMemberVO : projectMemberVOS) {
                SysUserInfoVO sysUserInfoVO = permService.sysUserQueryById(projectMemberVO.getUserId());
                projectMemberVO.setSysUserInfoVO(sysUserInfoVO);
            }
        }
        PropertyUtils.copyProperties(pageInfo, pageVO, projectMemberVOS);
