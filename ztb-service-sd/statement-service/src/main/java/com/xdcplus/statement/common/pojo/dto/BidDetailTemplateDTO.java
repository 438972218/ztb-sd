...
/**
 * 内容模板(BidDetailTemplate)表更新入参DTO类
 *
 * @author Fish.Fei
...
public class BidDetailTemplateDTO extends BaseBO implements Serializable {
    private static final long serialVersionUID = 287426732578174700L;
