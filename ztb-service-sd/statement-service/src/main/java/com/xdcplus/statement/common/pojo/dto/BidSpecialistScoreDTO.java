...
/**
 * 招标专家评分(BidSpecialistScore)表更新入参DTO类
 *
 * @author Fish.Fei
...
public class BidSpecialistScoreDTO extends BaseBO implements Serializable {
    private static final long serialVersionUID = -66531921405691939L;
