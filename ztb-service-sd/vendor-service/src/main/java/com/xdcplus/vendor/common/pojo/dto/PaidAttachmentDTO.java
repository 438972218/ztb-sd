...
/**
 * 竞价单附件(PaidAttachment)表更新入参DTO类
 *
 * @author Fish.Fei
 * @since 2021-09-03 09:02:19
 */
@Data
@EqualsAndHashCode(callSuper = true)
@ApiModel(description = "")
@SuppressWarnings("serial")
public class PaidAttachmentDTO extends BaseBO implements Serializable {
    private static final long serialVersionUID = -62739777517533314L;
