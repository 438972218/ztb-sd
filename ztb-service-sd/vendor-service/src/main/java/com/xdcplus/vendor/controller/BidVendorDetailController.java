...
public class BidVendorDetailController extends AbstractController {
    ...
    @ApiOperation("Post查询供应商内容明细（国内报价、国外报价）")
    @PostMapping(value = "/list", produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseVO<PageVO<BidVendorDetailVO>> findBidVendorDetailPost(@RequestBody BidVendorDetailFilterDTO bidVendorDetailFilterDTO) {

        log.info("findBidVendorDetailPost {}", bidVendorDetailFilterDTO);
    ...
    public ResponseVO<String> updateBidVendorDetailByOperation(@RequestBody BidVendorDetailDTO bidVendorDetailDTO) {
        ...
        return ResponseVO.success(bidVendorDetailDTO.getOperation());
    }
