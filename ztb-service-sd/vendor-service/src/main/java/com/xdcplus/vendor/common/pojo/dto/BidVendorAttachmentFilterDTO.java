...
/**
 * 招标供应商附件(BidVendorAttachment)表查询入参DTO类
 *
 * @author Fish.Fei
...
public class BidVendorAttachmentFilterDTO extends PageDTO implements Serializable {
    private static final long serialVersionUID = 491591821297085685L;
