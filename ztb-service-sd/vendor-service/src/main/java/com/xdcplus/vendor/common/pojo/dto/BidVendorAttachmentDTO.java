...
/**
 * 招标供应商附件(BidVendorAttachment)表更新入参DTO类
 *
 * @author Fish.Fei
...
public class BidVendorAttachmentDTO extends BaseBO implements Serializable {
    private static final long serialVersionUID = -79193408513142883L;
