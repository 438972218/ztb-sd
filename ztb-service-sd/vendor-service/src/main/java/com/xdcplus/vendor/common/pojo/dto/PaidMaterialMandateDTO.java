...
/**
 * 竞价品项授权记录(PaidMaterialMandate)表更新入参DTO类
 *
 * @author Fish.Fei
...
public class PaidMaterialMandateDTO extends BaseBO implements Serializable {
    private static final long serialVersionUID = -70830433471813308L;
    ...
    @ApiModelProperty("竞价供应商用户名称")
    private String paidVendorUserName;
