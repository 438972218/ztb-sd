...
/**
 * 模板题库表(VendorQuestionBank)表查询入参DTO类
 *
 * @author Fish.Fei
...
public class VendorQuestionBankFilterDTO extends PageDTO implements Serializable {
    private static final long serialVersionUID = -36890622336097997L;
