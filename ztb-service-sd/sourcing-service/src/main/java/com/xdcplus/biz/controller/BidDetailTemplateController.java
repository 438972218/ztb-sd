...
public class BidDetailTemplateController extends AbstractController {
    ...
    @ApiOperation("查询内容模板Post")
    @PostMapping(value = "/list", produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseVO<PageVO<BidDetailTemplateVO>> findBidDetailTemplatePost(@RequestBody BidDetailTemplateFilterDTO bidDetailTemplateFilterDTO) {

        log.info("findBidDetailTemplatePost {}", bidDetailTemplateFilterDTO);
