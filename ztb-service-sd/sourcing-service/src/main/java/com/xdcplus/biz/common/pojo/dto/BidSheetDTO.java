...
public class BidSheetDTO extends BaseBO implements Serializable {
    private static final long serialVersionUID = -13666805472051017L;
    ...
    @ApiModelProperty("退回到的用户id")
    private Long flowToUserId;

    @ApiModelProperty("退回到的状态id")
    private Long flowToStatusId;

    private List<BidDetailDTO> bidDetailDTOS;

    private List<BidVendorDTO> bidVendorDTOS;

    private List<BidSpecialistDTO> bidSpecialistDTOS;

    private List<BidAttachmentDTO> bidAttachmentDTOS;
