<template>
  <div>
    <div class="content-title">中标结果</div>
    <a-row>
    ...
    <a-row>
      ...
      <a-table :columns="columns1" :data-source="data1" :scroll="{ x: 1300 }">
        ...
        <template slot="allottedProp" slot-scope="text, record">
          <a-input v-model="record.allottedProp" />
        </template>
      </a-table>
    </a-row>
...
import {
  ...
  paidVendorMaterialBatchPutRequest,
  paidVendorMaterialNewPricePostRequest
