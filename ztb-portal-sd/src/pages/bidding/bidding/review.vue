    ...
    <a-row>
      ...
      >
        <template slot="detail" slot-scope="text, record">
          <div style="color: #40a9ff; cursor: pointer" @click="addNew(record.id)">
            查看
          </div>
        </template>
        <template slot="informationPass" slot-scope="text, record">
          <a-checkbox
          :checked="record.informationPass === '0'? false : record.informationPass === null ? false :true"
...
export default {
  ...
  methods: {
    ...
    changeBoxIfForce(e, data) {
      ...
      console.log(data.informationPass)
