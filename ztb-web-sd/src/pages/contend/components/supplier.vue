    ...
    <a-tabs v-model="activeKey">
      <a-tab-pane key="1" tab="供应商">
        <a-row style="padding-bottom: 5px">
          ...
          >
            <a-button type="primary" @click="handleVendorAdd"> 新增 </a-button>
          </a-col>
        </a-row>
        <a-table
...
import {
  ...
  getVendorwithVendorPageVO,
  paidVendorDeleteRequest,
  paidAttachmentGetwithUser,
  paidAttachmentPostRequest,
  paidAttachmentDeleteRequest,
  paidAttachmentPutRequest,
  paidVendorSaveWithMark,
...
export default {
  ...
  methods: {
    ...
    async getAnnexDataList () {
      ...
      const result = await paidAttachmentGetwithUser(data)
      if (result.code === 0) {
