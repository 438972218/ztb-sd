        ...
        >
          <div :key="col">
            <a-checkbox
              ...
              @change="
                (e) => handleChangeCheckbox(e.target, record.vendorCode, col)
              "
            />
            <template v-else>
              <a-checkbox
        ...
        <template slot="operation" slot-scope="text, record">
          <div class="editable-row-operations">
            <span v-if="record.editable">
              <a @click="() => save(record.vendorCode)">提交</a>

              <a @click="() => cancel(record.vendorCode)">取消</a>
              <!-- <a-popconfirm
                title="Sure to cancel?"
                @confirm="() => cancel(record.vendorCode)"
              >
                <a>取消</a>
              </a-popconfirm> -->
            </span>
...
const columns1 = [
...

  {
    ...
    width: 120,
    fixed: "right",
    dataIndex: "abandonInquiry",
    scopedSlots: { customRender: "abandonInquiry" },
  },
  {
    title: "再报价",
    width: 80,
    fixed: "right",
    dataIndex: "repeatOffer",
    scopedSlots: { customRender: "repeatOffer" },
  },
  {
    title: "还价-单价",
    width: 100,
  ...
  },
  {
    ...
    scopedSlots: { customRender: "dickerReason" },
  },
  {
    title: "操作",
    dataIndex: "operation",
