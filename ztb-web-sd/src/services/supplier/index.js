...
// 查询考核模板
export function vendorTemplateQbank (data) {
  return service({
    url: env.API_ZTB_PREFIX + "/vendorQuestionBank",
    method: "get",
    params: data,
  })
}
...
// 查询考核模板
export function vendorTemplateQbankWithChild (data) {
  return service({
    url: env.API_ZTB_PREFIX + "/vendorQuestionBank/queryWithChild",
    method: "get",
    params: data,
  })
}
...
export function vendorKpiGetRequest (data) {
  return service({
    url: env.API_ZTB_PREFIX + "/vendorKpi/request",
    method: "get",
    params: data,
  })
}
// 提交绩效考核
export function submitVendorKpi (data) {
  return service({
    url: env.API_ZTB_PREFIX + "/vendorKpi/submit",
    method: "post",
    data: data,
  })
}
// 修改绩效考核
export function updateVendorKpi (data) {
  return service({
...
// 删除绩效考核
export function destroyVendorKpi (id) {
  return service({
...
// 修改绩效考核
export function vendorKpiAgree (data) {
  return service({
    url: env.API_ZTB_PREFIX + "/vendorKpi/agree",
    method: "post",
    data: data,
  })
}
...
// 查询供应商用户
export function getVendorUserByVendorId (vendorId) {
  return service({
    url: env.API_VENDOR_PREFIX + "/vendorUser/" + vendorId,
    method: "get",
  })
}
// 查询供应商附件
export function getVendorAttachment (data) {
  return service({
    url: env.API_ZTB_PREFIX + "/vendorAttachment",
    method: "get",
    params: data,
  })
}
...
// 批量导入
export function importPostVendorFile (data) {
  return service({
    url: env.API_VENDOR_PREFIX + "/excel/importVendorFile",
    method: "post",
    data: data,
  })
}
