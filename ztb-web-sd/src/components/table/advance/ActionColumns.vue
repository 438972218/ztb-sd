      ...
      >
        <a-list-item>
          ...
          <template slot="actions">
            ...
            <!-- <a-slider style="width:100px;margin-left:20px"  :default-value="30" :min="1" :max="500"  @change="setSearch(col)"/> -->
            <!-- </a-tooltip> -->
          </template>
          <a-slider
            class="action-slider"
            ...
            :min="50"
            :max="400"
            @change="setSearch(...arguments,col)"
          />
        </a-list-item>
      </a-list>
...
import {resetTabel} from '@/utils/methods'
...
export default {
  ...
  methods: {
    ...
    //     }
    //     this.$set(column, "width", undefined);
    ...
    // },
       resetColumns() {
        ...
        backColumns.forEach((back, index) => {
          ...
          this.$set(column, "width", this.defaultValue);
          this.$set(column, 'searchAble', back.searchAble)
          // column.searchAble = back.searchAble
          this.resetSearch(column)
        })
